    ...
    return (
        <AbsoluteFill style={{ backgroundColor: 'white' }}>
            <TransitionSeries>
                ...
                {/* 2. Plastic Flows (19s = 570 frames total) */}
                ...
                {/* 3. Steel Flows (19s = 570 frames total) */}
                <TransitionSeries.Sequence durationInFrames={270}>
                ...
                {/* 5c. RVSF Map (360 frames) */}
                <TransitionSeries.Sequence durationInFrames={360}>
                    <Section_Map videoSrc="tata_media/RVSF_Map.mp4" />
                </TransitionSeries.Sequence>

                {/* 5d. Compliance Dashboards (980 frames) */}
                <TransitionSeries.Sequence durationInFrames={980}>
                    <Section4_Compliance 
