...
const react_1 = __webpack_require__(6540);
const NativeLayers_js_1 = __webpack_require__(7069);
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "matnext-demo:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmatnext_demo"] = self["webpackChunkmatnext_demo"] || [];
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./src/style/tailwind.css
var tailwind = __webpack_require__(1849);
;// CONCATENATED MODULE: ./src/style/tailwind.css
...
/* harmony default export */ const style_tailwind = (tailwind/* default */.A.locals || {});
...
var no_react = __webpack_require__(2453);
...
var SlidePresentation = ({
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.AbsoluteFill, {
    style,
    children
  });
};
  ...
  const childrenValue = (0,react.useMemo)(() => {
    ...
    return react.Children.map(flattedChildren, (child, i) => {
      ...
      if (next && prev && nextProgress !== null && prevProgress !== null) {
        ...
        return /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, {
...
;// CONCATENATED MODULE: ./src/style/tokens.ts
const COLOR_TOKENS = {
  primary: "#96CC39",
  // MatNEXT Green
  background: "#F9FAFB",
...
;// CONCATENATED MODULE: ./src/components/Typography.tsx




const { fontFamily: Typography_fontFamily } = loadFont();
const Typography = ({
  text,
  fontSize = 48,
  fontWeight = "bold",
  ...
  const translateY = (0,cjs.interpolate)(anim, [0, 1], [fontSize * 0.8, 0]);
  const opacity = (0,cjs.interpolate)(anim, [0, 0.5], [0, 1]);
  ...
  if (masked) {
    return /* @__PURE__ */ react.createElement("div", { style: { overflow: "hidden", width: "100%", padding: "10px 0" } }, content);
  }
  return content;
};

;// CONCATENATED MODULE: ./src/components/overhaul/PulsatingGrid.tsx
...
const PulsatingGrid = () => {
  ...
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { overflow: "hidden", backgroundColor: COLOR_TOKENS.background } }, Array.from({ length: ROWS }).map((_, i) => Array.from({ length: COLS }).map((_2, j) => {
    ...
    const size = (0,cjs.interpolate)(wave, [0, 1], [2, 5]);
    const opacity = (0,cjs.interpolate)(wave, [0, 1], [0.1, 0.4]);
...
;// CONCATENATED MODULE: ./src/scenes/overhaul/Section1_Intro.tsx
...
const Section1_Intro = () => {
  ...
  const scale = (0,cjs.interpolate)(anim, [0, 1], [1.1, 1]);
  const opacity = (0,cjs.interpolate)(anim, [0, 0.5], [0, 1]);
  const exitAnim = (0,cjs.interpolate)(frame, [120, 150], [1, 0], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: {
    ...
    top: "20%",
    filter: "blur(80px)"
  } }), /* @__PURE__ */ react.createElement(PulsatingGrid, null), /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: {
    justifyContent: "center",
    alignItems: "center"
  } }, /* @__PURE__ */ react.createElement("div", { style: {
    display: "flex",
    flexDirection: "column",
    alignItems: "center",
    transform: `scale(${(0,cjs.interpolate)(anim, [0, 1], [0.9, 1])})`,
    ...
    width: (0,cjs.interpolate)(anim, [0, 1], [0, 150]),
    height: 2,
    ...
    opacity: exitAnim
  } }))), /* @__PURE__ */ react.createElement("div", { style: { marginTop: 25, opacity: exitAnim } }, /* @__PURE__ */ react.createElement(
    Typography,
    {
      delay: 30,
    ...
    display: "flex",
    justifyContent: "center",
    opacity: (0,cjs.interpolate)(frame, [40, 60], [0, 1], { extrapolateRight: "clamp" }) * exitAnim,
    transform: `translateY(${(0,cjs.interpolate)(frame, [40, 60], [20, 0], { extrapolateRight: "clamp" })}px)`
    ...
    margin: 0,
    letterSpacing: 1
  } }, "www.matnext-app.com")), /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
    bottom: 100,
    left: "50%",
    transform: "translateX(-50%)",
    width: (0,cjs.interpolate)(anim, [0, 1], [0, 400]),
    height: 2,
...
;// CONCATENATED MODULE: ./src/components/overhaul/RecordingBlip.tsx


const RecordingBlip = () => {
  const frame = (0,cjs.useCurrentFrame)();
  const pulsation = (Math.sin(frame / 10) + 1) / 2;
  const dotOpacity = (0,cjs.interpolate)(pulsation, [0, 1], [0.3, 1]);
  const dotScale = (0,cjs.interpolate)(pulsation, [0, 1], [0.8, 1.2]);
...
;// CONCATENATED MODULE: ./src/scenes/overhaul/Section1a_Stakeholders.tsx
...
const Section1a_Stakeholders = () => {
  ...
  const opacity = (0,cjs.interpolate)(anim, [0, 1], [0, 1]);
...
const Section_Flow = ({
  ...
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { backgroundColor: "#F8FAF9" } }, /* @__PURE__ */ react.createElement("div", { style: {
    ...
    alignItems: "center",
    justifyContent: "center"
  } }, overlayTop > 0 && /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
    top: 0,
    left: 0,
    right: 0,
    ...
    backgroundColor,
    zIndex: 2
  } }), overlayBottom > 0 && /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
    bottom: 0,
    left: 0,
    right: 0,
    ...
    right: 60,
    zIndex: 20
  } }, /* @__PURE__ */ react.createElement(RecordingBlip, null)), title && /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
    top: 65,
  ...
  ), subtitle && /* @__PURE__ */ react.createElement("div", { style: { marginTop: -10 } }, /* @__PURE__ */ react.createElement(
    Typography,
    {
      text: subtitle,
      fontSize: 20,
...
;// CONCATENATED MODULE: ./src/components/overhaul/HighlightRing.tsx
...
const HighlightRing = ({
  ...
  const scale = (0,cjs.interpolate)(anim, [0, 1], [0.8, 1]);
  const opacity = (0,cjs.interpolate)(anim, [0, 0.5, 1], [0, 1, 1]);
  ...
  return /* @__PURE__ */ react.createElement("div", { style: {
    ...
    boxShadow: `0 0 20px ${COLOR_TOKENS.primary}66`,
    // 40% opacity
...
;// CONCATENATED MODULE: ./src/scenes/overhaul/Section1b_Traceability.tsx
...
const getKeyframeValue = (frame, keyframes, property) => {
  const sorted = [...keyframes].sort((a, b) => a.frame - b.frame);
  if (frame <= sorted[0].frame)
    return sorted[0][property];
  if (frame >= sorted[sorted.length - 1].frame)
    return sorted[sorted.length - 1][property];
  for (let i = 0; i < sorted.length - 1; i++) {
    const start = sorted[i];
    const end = sorted[i + 1];
    if (frame >= start.frame && frame <= end.frame) {
      return (0,cjs.interpolate)(frame, [start.frame, end.frame], [start[property], end[property]]);
    }
  }
  return sorted[0][property];
};
const Section1b_Traceability = () => {
  ...
  const lineAnim = (0,cjs.spring)({
    frame: frame - 10,
    fps,
    config: ANIMATION_TOKENS.slow
  });
  const revealAnim = (0,cjs.spring)({
    frame: frame - 15,
    fps,
    config: ANIMATION_TOKENS.slow
  });
  const lineHeight = (0,cjs.interpolate)(lineAnim, [0, 1], [0, 45]);
  const { durationInFrames } = (0,cjs.useVideoConfig)();
  const contentFade = (0,cjs.spring)({
    frame: frame - 5,
    // Start fading in earlier (at frame 5 instead of 15)
    fps,
    config: ANIMATION_TOKENS.slow
  });
  const exitAnim = (0,cjs.interpolate)(
    frame,
    [durationInFrames - 30, durationInFrames - 5],
    [1, 0],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp" }
  );
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { backgroundColor: COLOR_TOKENS.background } }, /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: {
    ...
    opacity: (0,cjs.interpolate)(lineAnim, [0, 0.1], [0, 1])
  } }), /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
    top: 60,
    left: 80,
    ...
    right: 60,
    zIndex: 20
  } }, /* @__PURE__ */ react.createElement(RecordingBlip, null)), isRing1Visible && /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
  ...
  )), isRing2Visible && /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
  ...
  )), /* @__PURE__ */ react.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", position: "relative" } }, /* @__PURE__ */ react.createElement("div", { style: {
    flex: 1,
    background: "white",
    ...
    cjs.OffthreadVideo,
    {
      src: (0,cjs.staticFile)("my_media/Traceability-Updated_HD.mp4"),
      playbackRate: 1.44,
      style: {
        width: "100%",
        height: "100%",
...
;// CONCATENATED MODULE: ./node_modules/lucide-react/dist/esm/icons/layout-grid.js
/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
;// CONCATENATED MODULE: ./src/components/overhaul/Toggle.tsx




const Toggle = ({ mode, delay = 0, animateTransition = false }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const { fps } = (0,cjs.useVideoConfig)();
  const anim = (0,cjs.spring)({
    frame: frame - delay,
  ...
  const startProgress = animateTransition ? mode === "corporate" ? 1 : 0 : mode === "corporate" ? 0 : 1;
  const progress = (0,cjs.interpolate)(anim, [0, 1], [startProgress, activeIndex], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  ...
  const sliderWidthRegulatory = 308;
  const sliderXCorporate = padding;
  const sliderXRegulatory = padding + sliderWidthCorporate;
  const sliderX = (0,cjs.interpolate)(progress, [0, 1], [sliderXCorporate, sliderXRegulatory]);
  const sliderWidth = (0,cjs.interpolate)(progress, [0, 1], [sliderWidthCorporate, sliderWidthRegulatory]);
  return /* @__PURE__ */ react.createElement("div", { style: {
    width: outerWidth,
    height: 92,
    ...
    borderRadius: 16,
    padding: 8,
    // Tightened padding to hug the slider deeply
    position: "relative",
    display: "flex",
    alignItems: "center",
    ...
    // Exactly half
    height: 76,
    // Height = Outer Height (92) - Top/Bot Padding (16)
    backgroundColor: COLOR_TOKENS.primary,
    borderRadius: 10,
  ...
  } }, /* @__PURE__ */ react.createElement(LayoutGrid, { size: 24 }), /* @__PURE__ */ react.createElement("span", { style: { fontWeight: 700, fontSize: 18 } }, "Corporate Overview")), /* @__PURE__ */ react.createElement("div", { style: {
    ...
    color: progress > 0.5 ? "white" : "#64748B",
    transition: "color 0.3s ease"
  } }, /* @__PURE__ */ react.createElement(ShieldCheck, { size: 24 }), /* @__PURE__ */ react.createElement("span", { style: { fontWeight: 700, fontSize: 18 } }, "Regulatory Compliance")));
};

;// CONCATENATED MODULE: ./src/components/overhaul/ToasterTabs.tsx



const ToasterTab = ({ label, active, delay = 0 }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const { fps } = (0,cjs.useVideoConfig)();
  const anim = (0,cjs.spring)({
    frame: frame - delay,
  ...
  const translateY = (0,cjs.interpolate)(anim, [0, 1], [40, 0]);
  const opacity = (0,cjs.interpolate)(anim, [0, 1], [0, 1]);
  return /* @__PURE__ */ react.createElement("div", { style: {
    padding: "12px 24px",
...
const ToasterTabs = ({ activeIndex = 0, delay = 0 }) => {
...
;// CONCATENATED MODULE: ./src/scenes/overhaul/Section_Map.tsx
...
const Section_Map = () => {
  ...
  const focusAnim = (0,cjs.spring)({
    frame,
    // Appear immediately with video start
    fps,
    config: ANIMATION_TOKENS.slow
  });
  const overlayOpacity = (0,cjs.interpolate)(focusAnim, [0, 1], [0, 0.4]);
  const lineHeight = (0,cjs.interpolate)(lineAnim, [0, 1], [0, 95]);
  const exitAnim = (0,cjs.interpolate)(frame, [durationInFrames - 30, durationInFrames - 5], [1, 0], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { backgroundColor: COLOR_TOKENS.background, opacity: exitAnim } }, /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
    top: 60,
    left: 60,
    width: 4,
    ...
    clipPath: `inset(0 ${100 - revealAnim * 100}% 0 0)`,
    transform: `translateX(${(0,cjs.interpolate)(revealAnim, [0, 1], [-20, 0])}px)`
  } }, /* @__PURE__ */ react.createElement(Typography, { text: "Registered Vehicle Scrapping Facility", fontSize: 30, fontWeight: 600, color: COLOR_TOKENS.text, textAlign: "left" }), /* @__PURE__ */ react.createElement(Typography, { delay: 15, text: "Map View", fontSize: 24, color: COLOR_TOKENS.textSecondary, fontWeight: 400, textAlign: "left" })), /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
    top: 60,
    right: 60,
    zIndex: 10
  } }, /* @__PURE__ */ react.createElement(Toggle, { mode: "corporate" })), /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: {
    padding: "160px 60px 60px 60px"
  } }, /* @__PURE__ */ react.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", position: "relative" } }, /* @__PURE__ */ react.createElement(ToasterTabs, { activeIndex: 1 }), /* @__PURE__ */ react.createElement("div", { style: {
    flex: 1,
    background: "white",
    borderRadius: "0 24px 24px 24px",
    border: `1px solid ${COLOR_TOKENS.border}`,
    ...
    cjs.Video,
    {
      src: (0,cjs.staticFile)("new_media/RVSF_Map.mp4"),
      style: {
        width: "100%",
        height: "100%",
        objectFit: "cover"
    ...
    padding: "10px 30px",
    borderRadius: 20,
    transform: `translateX(-50%) translateY(${(0,cjs.interpolate)(focusAnim, [0, 1], [0, -35])}px)`,
    opacity: focusAnim,
    zIndex: 15
  } }, /* @__PURE__ */ react.createElement(
    Typography,
...
;// CONCATENATED MODULE: ./src/components/overhaul/StatTile.tsx
...
const StatTile = ({
  ...
  const progressAnim = (0,cjs.spring)({
    frame: frame - delay,
    fps,
    config: ANIMATION_TOKENS.slow
  });
  ...
  const strokeDashoffset = (0,cjs.interpolate)(
    progressAnim,
    [0, 1],
  ...
  return /* @__PURE__ */ react.createElement("div", { style: {
    ...
    opacity: entrance,
    transform: `translateY(${(0,cjs.interpolate)(entrance, [0, 1], [20, 0])}px)`
    ...
    justifyContent: "center",
    color
  } }, icon), /* @__PURE__ */ react.createElement("div", { style: { display: "flex", flexDirection: "column" } }, /* @__PURE__ */ react.createElement("span", { style: {
    fontSize: 15,
    fontWeight: 700,
    color: COLOR_TOKENS.textSecondary,
    letterSpacing: 0.5,
    ...
    textTransform: "uppercase",
    color: COLOR_TOKENS.textSecondary
  } }, subLabel))), /* @__PURE__ */ react.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", flex: 1 } }, /* @__PURE__ */ react.createElement("div", { style: { display: "flex", flexDirection: "column" } }, /* @__PURE__ */ react.createElement("div", { style: { display: "flex", alignItems: "baseline", gap: 4 } }, /* @__PURE__ */ react.createElement("span", { style: {
    fontSize: 32,
    fontWeight: 800,
    color,
    textTransform: "uppercase"
    ...
    textTransform: "uppercase",
    color: COLOR_TOKENS.textSecondary
  } }, unit)), /* @__PURE__ */ react.createElement("span", { style: {
    fontSize: 12,
    fontWeight: 600,
    color: COLOR_TOKENS.textSecondary,
    marginTop: 4,
    textTransform: "uppercase"
  } }, targetText)), /* @__PURE__ */ react.createElement("div", { style: { position: "relative", width: 80, height: 80, flexShrink: 0 } }, /* @__PURE__ */ react.createElement("svg", { width: "80", height: "80", viewBox: "0 0 100 100", style: { transform: "rotate(-90deg)" } }, /* @__PURE__ */ react.createElement(
    "circle",
    {
      cx: "50",
      cy: "50",
...
;// CONCATENATED MODULE: ./node_modules/lucide-react/dist/esm/icons/droplets.js
/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
;// CONCATENATED MODULE: ./node_modules/lucide-react/dist/esm/icons/zap.js
/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
;// CONCATENATED MODULE: ./node_modules/lucide-react/dist/esm/icons/truck.js
/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
;// CONCATENATED MODULE: ./node_modules/lucide-react/dist/esm/icons/battery.js
/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
;// CONCATENATED MODULE: ./node_modules/lucide-react/dist/esm/icons/layers.js
/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
;// CONCATENATED MODULE: ./src/components/overhaul/StatTilesContainer.tsx



const StatTilesContainer = ({ delay = 0 }) => {
  return /* @__PURE__ */ react.createElement("div", { style: {
    display: "flex",
    gap: 25,
    width: "100%",
    ...
    StatTile,
    {
      ...
      percentage: 75,
      color: "#10B981",
      icon: /* @__PURE__ */ react.createElement(Droplets, { size: 20 }),
      delay
    }
  ), /* @__PURE__ */ react.createElement(
    StatTile,
    {
      ...
      percentage: 91,
      color: "#3B82F6",
      icon: /* @__PURE__ */ react.createElement(Zap, { size: 20 }),
      delay
    }
  ), /* @__PURE__ */ react.createElement(
    StatTile,
    {
      ...
      percentage: 88,
      color: "#F59E0B",
      icon: /* @__PURE__ */ react.createElement(Truck, { size: 20 }),
      delay
    }
  ), /* @__PURE__ */ react.createElement(
    StatTile,
    {
      ...
      percentage: 0,
      color: "#8B5CF6",
      icon: /* @__PURE__ */ react.createElement(Battery, { size: 20 }),
      delay
    }
  ), /* @__PURE__ */ react.createElement(
    StatTile,
    {
      ...
      percentage: 0,
      color: "#EC4899",
      icon: /* @__PURE__ */ react.createElement(Layers, { size: 20 }),
      delay
    }
  ));
};

;// CONCATENATED MODULE: ./src/scenes/overhaul/Section2_OEM.tsx
...
const Section2_OEM = () => {
  ...
  const TOGGLE_CENTER_DUR = SCENE_START_DELAY + 25;
  const TOGGLE_MOVE_TIME = 25;
  ...
  const EXIT_START = DASHBOARD_ENTRANCE + 110;
  const BLIP_TOP = 162;
  const BLIP_RIGHT = 60;
  const toggleEntrance = (0,cjs.spring)({
    frame: frame - SCENE_START_DELAY,
    fps,
    config: ANIMATION_TOKENS.slow
  });
  const isToggleMoving = frame > TOGGLE_CENTER_DUR;
  const toggleMoveProgress = (0,cjs.spring)({
    frame: frame - TOGGLE_CENTER_DUR,
    fps,
    config: ANIMATION_TOKENS.extraSlow
    // Use extraSlow
  });
  const toggleY = (0,cjs.interpolate)(toggleMoveProgress, [0, 1], [height / 2 - 46, 60]);
  const toggleX = (0,cjs.interpolate)(toggleMoveProgress, [0, 1], [width / 2 - 298, width - 656]);
  const toggleScale = (0,cjs.interpolate)(toggleEntrance, [0, 1], [0.8, 1]);
  const toggleFadeOut = (0,cjs.spring)({
    frame: frame - (TOGGLE_CENTER_DUR + 40),
    // Start fading mid-move/end-move
    fps,
    config: ANIMATION_TOKENS.slow
  });
  const toggleOpacity = (0,cjs.interpolate)(toggleFadeOut, [0, 1], [1, 0]);
  ...
  const dashboardAnim = (0,cjs.spring)({
  ...
  const dashboardScale = 1;
  const dashboardTranslateY = 0;
  const overlayOpacity = (0,cjs.interpolate)(focusAnim, [0, 1], [0, 0.4]);
  const liftAnim = (0,cjs.spring)({
    frame: frame - SCORE_FOCUS_START,
    fps,
    config: ANIMATION_TOKENS.slow
  });
  const tileScale = (0,cjs.interpolate)(liftAnim, [0, 1], [1, 1.1]);
  const tileLift = (0,cjs.interpolate)(liftAnim, [0, 1], [0, -60]);
  const tileShiftX = (0,cjs.interpolate)(liftAnim, [0, 1], [0, -35]);
  const bgBlur = (0,cjs.interpolate)(liftAnim, [0, 1], [0, 6]);
  const exitAnim = (0,cjs.interpolate)(frame, [durationInFrames - 30, durationInFrames - 5], [1, 0], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { backgroundColor: COLOR_TOKENS.background } }, /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
    top: 60,
    // Equal top margin
    left: 60,
    ...
    backgroundColor: COLOR_TOKENS.primary,
    // borderRadius: 2,
    opacity: (0,cjs.interpolate)(lineAnim, [0, 0.1], [0, 1]) * exitAnim
  } }), /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
    top: 60,
    // Equal top margin
    left: 80,
    // 60px base + 20px gap from the vertical line
    ...
    transform: `translateY(${(0,cjs.interpolate)(dashboardAnim, [0, 1], [10, 0])}px)`,
    zIndex: 15
  } }, /* @__PURE__ */ react.createElement(RecordingBlip, null)), /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
    top: toggleY,
    left: toggleX,
    transform: `scale(${toggleScale})`,
    opacity: (0,cjs.interpolate)(toggleEntrance, [0, 1], [0, 1]) * exitAnim,
    // Always visible after entrance
    zIndex: 10
  } }, /* @__PURE__ */ react.createElement(Toggle, { mode: "corporate" })), /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: {
    padding: "160px 60px 60px 60px",
    // Uniform padding around the dashboard area
    opacity: dashboardAnim * exitAnim,
    transform: `translateY(${(0,cjs.interpolate)(dashboardAnim, [0, 1], [40, 0])}px)`
  } }, /* @__PURE__ */ react.createElement("div", { style: {
    flex: 1,
    display: "flex",
    flexDirection: "column",
  ...
  } }, /* @__PURE__ */ react.createElement(ToasterTabs, { activeIndex: 0, delay: TOASTER_WAVE_START }), /* @__PURE__ */ react.createElement("div", { style: {
    flex: 1,
    background: "white",
    borderRadius: "0 24px 24px 24px",
    border: `1px solid ${COLOR_TOKENS.border}`,
    ...
    cjs.Img,
    {
      src: (0,cjs.staticFile)("my_media/MSIL-Dashboard.png"),
      style: {
        width: "100%",
        height: "100%",
        objectFit: "cover",
    ...
    position: "absolute",
    top: "46.5%",
    // Precise vertical alignment with mockup row
    left: "5.5%",
    // Shifted right
    width: "93.4%",
    // Adjusted width
    ...
    transformOrigin: "center center"
  } }, /* @__PURE__ */ react.createElement(StatTilesContainer, { delay: DASHBOARD_ENTRANCE })), frame > ISOLATION_FOCUS_START && /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
    top: "44.6%",
    // Slightly larger to encompass the tiles
    left: "4.7%",
    // Shifted right to match cards
    width: "95.2%",
    // Adjusted width
    height: "21%",
    border: `6px solid ${COLOR_TOKENS.primary}`,
    ...
    opacity: focusAnim,
    zIndex: 6
  } }), frame > ISOLATION_FOCUS_START && /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
    top: "70%",
    left: "50%",
    backgroundColor: "black",
...
;// CONCATENATED MODULE: ./src/components/overhaul/RVSFMaterialCard.tsx
...
const RVSFMaterialCard = ({ delay = 0 }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const { fps } = (0,cjs.useVideoConfig)();
  const entrance = (0,cjs.spring)({
    frame: frame - delay,
  ...
  return /* @__PURE__ */ react.createElement("div", { style: {
    ...
    paddingBottom: 8
  } }, "Material Recovery Details (Kgs):"), /* @__PURE__ */ react.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", gap: 6 } }, DATA.map((item, i) => /* @__PURE__ */ react.createElement("div", { key: item.label, style: {
    display: "flex",
  ...
  } }, /* @__PURE__ */ react.createElement("span", null, item.label), /* @__PURE__ */ react.createElement("span", { style: {
...
;// CONCATENATED MODULE: ./src/components/overhaul/RVSFPerformanceCard.tsx



const RVSFPerformanceCard_DATA = [
...
const RVSFPerformanceCard = ({ delay = 0 }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const { fps } = (0,cjs.useVideoConfig)();
  const entrance = (0,cjs.spring)({
    frame: frame - delay,
  ...
  return /* @__PURE__ */ react.createElement("div", { style: {
    ...
    transform: `translateY(${(0,cjs.interpolate)(entrance, [0, 1], [20, 0])}px)`,
    fontFamily: "Inter, sans-serif"
  } }, /* @__PURE__ */ react.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", gap: 6 } }, RVSFPerformanceCard_DATA.map((item, i) => /* @__PURE__ */ react.createElement("div", { key: item.label, style: {
    display: "flex",
    justifyContent: "space-between",
    alignItems: "center",
    fontSize: 14,
    ...
    fontWeight: 700,
    fontVariantNumeric: "tabular-nums"
  } }, item.value)))), /* @__PURE__ */ react.createElement("div", { style: { marginTop: 12 } }, /* @__PURE__ */ react.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: 4 } }, /* @__PURE__ */ react.createElement("span", { style: { fontSize: 13, fontWeight: 700, color: "#166534" } }, "Performance Rating"), /* @__PURE__ */ react.createElement("span", { style: { fontSize: 12, fontWeight: 700, color: "#166534" } }, "101.115% of Target")), /* @__PURE__ */ react.createElement("div", { style: {
    width: "100%",
    height: 8,
...
;// CONCATENATED MODULE: ./src/components/overhaul/RVSFScrapCard.tsx



const RVSFScrapCard_DATA = [
...
const RVSFScrapCard = ({ delay = 0 }) => {
  ...
  return /* @__PURE__ */ react.createElement("div", { style: {
  ...
  } }, "Scrap Dispatch Details:"), /* @__PURE__ */ react.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", gap: 8 } }, RVSFScrapCard_DATA.map((item, i) => /* @__PURE__ */ react.createElement("div", { key: item.label, style: {
    display: "flex",
    justifyContent: "space-between",
    alignItems: "center",
    fontSize: 14,
    ...
    color: "#1d4ed8",
    padding: "4px 0",
    borderBottom: i === RVSFScrapCard_DATA.length - 1 ? "none" : "1px solid #eff6ff"
  } }, /* @__PURE__ */ react.createElement("span", { style: { flex: 1 } }, item.label), /* @__PURE__ */ react.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ react.createElement("span", { style: {
    color: "#1e3a8a",
    fontWeight: 700,
    fontVariantNumeric: "tabular-nums"
  } }, item.value), /* @__PURE__ */ react.createElement("div", { style: {
    width: 45,
    textAlign: "right",
    color: "#166534",
    fontSize: 13,
    ...
    alignItems: "center",
    gap: 2
  } }, item.rating !== "0" && /* @__PURE__ */ react.createElement("span", { style: { color: "#F59E0B" } }, "\u2605"), item.rating))))));
};

;// CONCATENATED MODULE: ./src/scenes/overhaul/Section3_SupplyChain.tsx
...
const DashboardSlide = ({ imageUrl, activeIndex, title, highlightTop = "37.8%", highlightHeight = "33%" }) => {
  ...
  const focusAnim = (0,cjs.spring)({
    frame: frame - 10,
    // Start highlight almost immediately
    fps,
    config: ANIMATION_TOKENS.slow
  });
  const overlayOpacity = (0,cjs.interpolate)(focusAnim, [0, 1], [0, 0.4]);
  ...
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { backgroundColor: COLOR_TOKENS.background, opacity: exitAnim } }, /* @__PURE__ */ react.createElement("div", { style: {
    ...
    padding: "160px 60px 60px 60px"
  } }, /* @__PURE__ */ react.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", position: "relative" } }, /* @__PURE__ */ react.createElement(ToasterTabs, { activeIndex }), /* @__PURE__ */ react.createElement("div", { style: {
    flex: 1,
    background: "white",
    borderRadius: "0 24px 24px 24px",
    border: `1px solid ${COLOR_TOKENS.border}`,
    ...
    overflow: "hidden",
    position: "relative"
  } }, /* @__PURE__ */ react.createElement(cjs.Img, { src: (0,cjs.staticFile)(imageUrl), style: { width: "100%", height: "100%", objectFit: "cover", objectPosition: "top center" } }), /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
    top: "38.5%",
    // Slightly higher to cover
    left: "4.2%",
    width: "95.5%",
    // Wider to cover right edge
    height: "31.5%",
    // Taller to cover bottom edge
    backgroundColor: "#F5F4EB",
    // Corrected dashboard background
    borderRadius: "20px",
    zIndex: 5,
    display: "flex",
    gap: "0.6%",
    padding: "12px 16px"
    // Slightly more padding for internal centering
  } }, /* @__PURE__ */ react.createElement("div", { style: { flex: 1.05 } }, /* @__PURE__ */ react.createElement(RVSFPerformanceCard, { delay: 0 })), /* @__PURE__ */ react.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ react.createElement(RVSFScrapCard, { delay: 0 })), /* @__PURE__ */ react.createElement("div", { style: { flex: 1.02 } }, /* @__PURE__ */ react.createElement(RVSFMaterialCard, { delay: 0 }))), frame > 5 && /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
    top: highlightTop,
    // Positioned over the 4 cards
    left: "4%",
    width: "96%",
    height: highlightHeight,
    border: `6px solid ${COLOR_TOKENS.primary}`,
    borderRadius: 25,
    // Slightly softer corners to match cards
    boxShadow: `0 0 0 1000px rgba(0,0,0,${overlayOpacity * 1.5})`,
    // Darkening outside only
    transform: `scale(${focusAnim})`,
...
;// CONCATENATED MODULE: ./src/scenes/overhaul/Section4_Compliance.tsx





const Section4_Compliance = () => {
  const frame = (0,cjs.useCurrentFrame)();
  const { fps, width, height, durationInFrames } = (0,cjs.useVideoConfig)();
  const MOVE_TO_CENTER_START = 10;
  const moveToCenter = (0,cjs.spring)({ frame: frame - MOVE_TO_CENTER_START, fps, config: ANIMATION_TOKENS.slow });
  const TOGGLE_SWITCH_START = 35;
  const MOVE_BACK_START = 60;
  const moveBack = (0,cjs.spring)({ frame: frame - MOVE_BACK_START, fps, config: ANIMATION_TOKENS.slow });
  const startX = width - 656;
  const startY = 60;
  const centerX = width / 2 - 298;
  const centerY = height / 2 - 46;
  const toggleX = (0,cjs.interpolate)(moveToCenter, [0, 1], [startX, centerX]) + (0,cjs.interpolate)(moveBack, [0, 1], [0, startX - centerX]);
  const toggleY = (0,cjs.interpolate)(moveToCenter, [0, 1], [startY, centerY]) + (0,cjs.interpolate)(moveBack, [0, 1], [0, startY - centerY]);
  const LINE_START = MOVE_BACK_START + 5;
  const TEXT_START = LINE_START + 10;
  const board1Start = MOVE_BACK_START + 20;
  const board1Highlight = board1Start + 45;
  const board1End = board1Start + 136;
  const board2Start = board1End;
  const board2Highlight = board2Start + 45;
  const board2End = board2Start + 137;
  const board3Start = board2End;
  const board3Highlight = board3Start + 45;
  const board3End = board3Start + 137;
  const exitAnim = (0,cjs.interpolate)(frame, [durationInFrames - 30, durationInFrames - 5], [1, 0], { extrapolateRight: "clamp" });
  ...
  const lineAnim = (0,cjs.spring)({ frame: frame - lineStart, fps, config: ANIMATION_TOKENS.slow });
  const lineHeight = (0,cjs.interpolate)(lineAnim, [0, 1], [0, 95]);
  const revealAnim = (0,cjs.spring)({ frame: frame - textStart, fps, config: ANIMATION_TOKENS.slow });
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { backgroundColor: COLOR_TOKENS.background, opacity: exitAnim } }, /* @__PURE__ */ react.createElement("div", { style: { position: "absolute", top: 60, left: 60, width: 4, height: lineHeight, backgroundColor: COLOR_TOKENS.primary, opacity: (0,cjs.interpolate)(lineAnim, [0, 0.1], [0, 1]) } }), /* @__PURE__ */ react.createElement("div", { style: { position: "absolute", top: 60, left: 80, opacity: revealAnim, transform: `translateX(${(0,cjs.interpolate)(revealAnim, [0, 1], [-20, 0])}px)` } }, /* @__PURE__ */ react.createElement(Typography, { text: headerTitle, fontSize: 30, fontWeight: 600, color: COLOR_TOKENS.text, textAlign: "left" }), /* @__PURE__ */ react.createElement(Typography, { delay: 15, text: headerSub, fontSize: 24, color: COLOR_TOKENS.textSecondary, fontWeight: 400, textAlign: "left" })), /* @__PURE__ */ react.createElement("div", { style: { position: "absolute", top: toggleY, left: toggleX, zIndex: 10 } }, /* @__PURE__ */ react.createElement(Toggle, { mode: "regulatory", delay: TOGGLE_SWITCH_START, animateTransition: true })), /* @__PURE__ */ react.createElement("div", { style: { position: "absolute", top: 200, left: 60, right: 60, bottom: -1, opacity: (0,cjs.interpolate)(frame, [board1Start, board1Start + 20, board1End, board1End + 20], [0, 1, 1, 0], { extrapolateRight: "clamp" }), display: frame >= board1Start && frame < board1End + 30 ? "block" : "none" } }, /* @__PURE__ */ react.createElement("div", { style: { width: "100%", height: "100%", background: "white", border: `1px solid ${COLOR_TOKENS.border}`, borderRadius: "0px 24px 0px 0px", overflow: "hidden", position: "relative", boxShadow: "0 20px 80px rgba(0,0,0,0.08)" } }, /* @__PURE__ */ react.createElement(cjs.Img, { src: (0,cjs.staticFile)("my_media/CBAM.png"), style: { width: "100%", height: "100%", objectFit: "cover", objectPosition: "top center" } }), frame > board1Highlight && /* @__PURE__ */ react.createElement("div", { style: { position: "absolute", top: "29%", left: "4%", width: "96%", height: "53%", border: `6px solid ${COLOR_TOKENS.primary}`, borderRadius: 25, boxShadow: `0 0 0 1000px rgba(0,0,0,0.4)`, opacity: (0,cjs.interpolate)(frame, [board1Highlight, board1Highlight + 15], [0, 1]), transform: `scale(${(0,cjs.spring)({ frame: frame - board1Highlight, fps, config: ANIMATION_TOKENS.slow })})` } }))), /* @__PURE__ */ react.createElement("div", { style: { position: "absolute", top: 200, left: 60, right: 60, bottom: -1, opacity: (0,cjs.interpolate)(frame, [board2Start, board2Start + 20, board2End, board2End + 20], [0, 1, 1, 0], { extrapolateRight: "clamp" }), display: frame >= board2Start && frame < board2End + 30 ? "block" : "none" } }, /* @__PURE__ */ react.createElement("div", { style: { width: "100%", height: "100%", background: "white", border: `1px solid ${COLOR_TOKENS.border}`, borderRadius: "0px 24px 0px 0px", overflow: "hidden", position: "relative", boxShadow: "0 20px 80px rgba(0,0,0,0.08)" } }, /* @__PURE__ */ react.createElement(cjs.Img, { src: (0,cjs.staticFile)("my_media/Regulatory-Landscape.png"), style: { width: "100%", height: "100%", objectFit: "cover", objectPosition: "top center" } }), frame > board2Highlight && /* @__PURE__ */ react.createElement("div", { style: { position: "absolute", top: "30%", left: "5%", width: "94%", height: "7.5%", border: `6px solid ${COLOR_TOKENS.primary}`, borderRadius: 25, boxShadow: `0 0 0 1000px rgba(0,0,0,0.4)`, opacity: (0,cjs.interpolate)(frame, [board2Highlight, board2Highlight + 15], [0, 1]), transform: `scale(${(0,cjs.spring)({ frame: frame - board2Highlight, fps, config: ANIMATION_TOKENS.slow })})` } }))), /* @__PURE__ */ react.createElement("div", { style: { position: "absolute", top: 200, left: 60, right: 60, bottom: -1, opacity: (0,cjs.interpolate)(frame, [board3Start, board3Start + 20, board3End, board3End + 20], [0, 1, 1, 0], { extrapolateRight: "clamp" }), display: frame >= board3Start ? "block" : "none" } }, /* @__PURE__ */ react.createElement("div", { style: { width: "100%", height: "100%", background: "white", border: `1px solid ${COLOR_TOKENS.border}`, borderRadius: "0px 24px 0px 0px", overflow: "hidden", position: "relative", boxShadow: "0 20px 80px rgba(0,0,0,0.08)" } }, /* @__PURE__ */ react.createElement(cjs.Img, { src: (0,cjs.staticFile)("my_media/VW-CBAM.png"), style: { width: "100%", height: "100%", objectFit: "cover", objectPosition: "top center" } }), frame > board3Highlight && /* @__PURE__ */ react.createElement("div", { style: { position: "absolute", top: "23.5%", left: "5%", width: "93.8%", height: "9.5%", border: `6px solid ${COLOR_TOKENS.primary}`, borderRadius: 25, boxShadow: `0 0 0 1000px rgba(0,0,0,0.4)`, opacity: (0,cjs.interpolate)(frame, [board3Highlight, board3Highlight + 15], [0, 1]), transform: `scale(${(0,cjs.spring)({ frame: frame - board3Highlight, fps, config: ANIMATION_TOKENS.slow })})` } }))));
};

;// CONCATENATED MODULE: ./src/scenes/overhaul/Section5_FutureScope.tsx



const Section5_FutureScope = () => {
  const frame = (0,cjs.useCurrentFrame)();
  const { fps, durationInFrames } = (0,cjs.useVideoConfig)();
  const anim = (0,cjs.spring)({
    frame,
  ...
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: {
    ...
    cjs.Img,
    {
      src: (0,cjs.staticFile)("new_media/Future Scope.png"),
      style: {
        width: "100%",
        height: "100%",
        objectFit: "contain",
...
;// CONCATENATED MODULE: ./src/scenes/Outro.tsx
...
const Main = () => {
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { backgroundColor: "white" } }, /* @__PURE__ */ react.createElement(TransitionSeries, null, /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 60 }, /* @__PURE__ */ react.createElement(Section1_Intro, null)), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 60 }, /* @__PURE__ */ react.createElement(Section1a_Stakeholders, null)), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 135 }, /* @__PURE__ */ react.createElement(Section_Flow, { src: "new_media/Plastic Overall Flow.png", title: "End-to-End Plastic Traceability", centerTitle: true, subtitle: "(Actual data captured in MatNEXT system)" })), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 50 }, /* @__PURE__ */ react.createElement(Section_Flow, { src: "new_media/Plastic Phase 1.png", title: "Phase 1: Capturing Data at the point of Recovery", scale: 1.2, translateX: -60, translateY: -20, overlayTop: 110, overlayBottom: 50 })), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 50 }, /* @__PURE__ */ react.createElement(Section_Flow, { src: "new_media/Plastic Phase 2.png", title: "Phase 2: Tracking Material Transformation through Recycling", scale: 1.22, translateX: -70, translateY: -23, overlayTop: 90, overlayBottom: 60 })), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 50 }, /* @__PURE__ */ react.createElement(Section_Flow, { src: "new_media/Plastic Phase 3.png", title: "Phase 3: Manufacturing and the Circular Return Loop", scale: 1.15, translateX: -10, translateY: -50, overlayTop: 115, overlayBottom: 105 })), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 135 }, /* @__PURE__ */ react.createElement(Section_Flow, { src: "new_media/Steel Overall Flow.png", title: "End-to-End Steel Traceability", backgroundColor: "#F1F2F6", scale: 1.06, translateX: 0, translateY: -5, overlayTop: 35, overlayBottom: 35, centerTitle: true, subtitle: "(Actual data captured in MatNEXT system)" })), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 50 }, /* @__PURE__ */ react.createElement(Section_Flow, { src: "new_media/Steel Phase 1.png", title: "Phase 1: Capturing Data at the point of Recovery", backgroundColor: "#F0F2F5", scale: 1.15, translateX: -35, translateY: -5 })), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 50 }, /* @__PURE__ */ react.createElement(Section_Flow, { src: "new_media/Steel Phase 2.png", title: "Phase 2: Tracking Material Transformation through Recycling", scale: 1.18, translateX: -1, translateY: -5 })), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 50 }, /* @__PURE__ */ react.createElement(Section_Flow, { src: "new_media/Steel Phase 3.png", title: "Phase 3: Manufacturing and the Circular Return Loop", scale: 1.27, translateX: -8, translateY: -5 })), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 340 }, /* @__PURE__ */ react.createElement(Section1b_Traceability, null)), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 230 }, /* @__PURE__ */ react.createElement(Section2_OEM, null)), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 130 }, /* @__PURE__ */ react.createElement(Section3_SupplyChain, null)), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 180 }, /* @__PURE__ */ react.createElement(Section_Map, null)), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 490 }, /* @__PURE__ */ react.createElement(Section4_Compliance, null)), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 100 }, /* @__PURE__ */ react.createElement(Section5_FutureScope, null)), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 60 }, /* @__PURE__ */ react.createElement(Outro, null))));
};
...
;// CONCATENATED MODULE: ./src/components/showreel/DataOverlay.tsx




const DataOverlay = ({ data, delay = 0 }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const { fps } = (0,cjs.useVideoConfig)();
  const openSpring = (0,cjs.spring)({
    frame: frame - delay,
    fps,
  ...
  return /* @__PURE__ */ react.createElement("div", { style: {
    ...
    opacity: (0,cjs.interpolate)(openSpring, [0.4, 0.8], [0, 1]),
    marginBottom: 4
  } }, /* @__PURE__ */ react.createElement(Typography, { text: "VERIFIED DATA", fontSize: 11, color: COLOR_TOKENS.primary, fontWeight: 800, letterSpacing: 1 })), Object.entries(data).map(([key, value], i) => {
    const start = Math.min(0.5 + i * 0.05, 0.8);
    return /* @__PURE__ */ react.createElement("div", { key, style: {
      display: "flex",
      flexDirection: "column",
      opacity: (0,cjs.interpolate)(openSpring, [start, 1], [0, 1], { extrapolateLeft: "clamp" }),
      gap: "2px"
    } }, /* @__PURE__ */ react.createElement(
      Typography,
      {
...
;// CONCATENATED MODULE: ./src/components/showreel/FlowAnimator.tsx





const NodeIcon = ({ type, active, delay }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const color = active ? COLOR_TOKENS.primary : "rgba(255,255,255,0.4)";
  const drawProgress = (0,cjs.interpolate)(frame, [delay + 10, delay + 30], [0, 1], { extrapolateRight: "clamp" });
  const props = {
    width: "48",
    height: "48",
    viewBox: "0 0 24 24",
  ...
  switch (type) {
    case "heat":
      return /* @__PURE__ */ react.createElement("svg", { ...props }, /* @__PURE__ */ react.createElement("defs", null, /* @__PURE__ */ react.createElement("linearGradient", { id: "metal-flow", x1: "0%", y1: "0%", x2: "0%", y2: "100%" }, /* @__PURE__ */ react.createElement("stop", { offset: "0%", stopColor: "#fff" }), /* @__PURE__ */ react.createElement("stop", { offset: "100%", stopColor: COLOR_TOKENS.primary }))), /* @__PURE__ */ react.createElement("path", { pathLength: 100, d: "M7 11V7a5 5 0 0110 0v4M5 11h14v7a3 3 0 01-3 3H8a3 3 0 01-3-3v-7z", fill: active ? "url(#metal-flow)" : "none", fillOpacity: 0.1 }), /* @__PURE__ */ react.createElement("path", { pathLength: 100, d: "M9 14h6M9 17h6", strokeOpacity: 0.5 }), /* @__PURE__ */ react.createElement("circle", { cx: "12", cy: "14", r: "1.5", fill: COLOR_TOKENS.primary }));
    case "rolling":
      return /* @__PURE__ */ react.createElement("svg", { ...props }, /* @__PURE__ */ react.createElement("circle", { pathLength: 100, cx: "8", cy: "12", r: "3.5", strokeWidth: "2" }), /* @__PURE__ */ react.createElement("circle", { pathLength: 100, cx: "16", cy: "12", r: "3.5", strokeWidth: "2" }), /* @__PURE__ */ react.createElement("rect", { pathLength: 100, x: "3", y: "10", width: "18", height: "4", rx: "1", fill: active ? COLOR_TOKENS.primary : "none", fillOpacity: 0.2 }));
    case "forging":
      return /* @__PURE__ */ react.createElement("svg", { ...props }, /* @__PURE__ */ react.createElement("path", { pathLength: 100, d: "M4 21h16M12 3v10M8 13h8M7 21v-4h10v4", strokeWidth: "2" }), /* @__PURE__ */ react.createElement("rect", { pathLength: 100, x: "9", y: "13", width: "6", height: "4", fill: active ? COLOR_TOKENS.primary : "none", fillOpacity: 0.3 }));
    case "machining":
      return /* @__PURE__ */ react.createElement("svg", { ...props }, /* @__PURE__ */ react.createElement("circle", { pathLength: 100, cx: "12", cy: "12", r: "5", strokeWidth: "2" }), /* @__PURE__ */ react.createElement("path", { d: "M12 7v10M7 12h10", strokeOpacity: 0.5 }));
    case "assembly":
      return /* @__PURE__ */ react.createElement("svg", { ...props }, /* @__PURE__ */ react.createElement("path", { pathLength: 100, d: "M12 18v2a2 2 0 01-2 2H6M20 4v8a2 2 0 01-2 2h-4M12 14v-4l-4-4", strokeWidth: "2" }), /* @__PURE__ */ react.createElement("circle", { pathLength: 100, cx: "12", cy: "14", r: "2.5", fill: active ? COLOR_TOKENS.primary : "none", fillOpacity: 0.5 }), /* @__PURE__ */ react.createElement("path", { d: "M15 14l3 3", strokeOpacity: 0.5 }));
    case "source":
      return /* @__PURE__ */ react.createElement("svg", { ...props }, /* @__PURE__ */ react.createElement("path", { pathLength: 100, d: "M3 21h18M3 7l9-4 9 4M4 21V7m16 14V7M9 21v-4a3 3 0 016 0v4" }), /* @__PURE__ */ react.createElement("path", { d: "M12 11v4M10 13h4", strokeOpacity: 0.4 }));
    case "process":
      return /* @__PURE__ */ react.createElement("svg", { ...props }, /* @__PURE__ */ react.createElement("path", { pathLength: 100, d: "M12 2v4m0 12v4M4.93 4.93l2.83 2.83m8.48 8.48l2.83 2.83M2 12h4m12 0h4M4.93 19.07l2.83-2.83m8.48-8.48l2.83-2.83" }), /* @__PURE__ */ react.createElement("circle", { pathLength: 100, cx: "12", cy: "12", r: "4" }));
    case "container":
      return /* @__PURE__ */ react.createElement("svg", { ...props }, /* @__PURE__ */ react.createElement("rect", { pathLength: 100, x: "3", y: "3", width: "18", height: "18", rx: "2", strokeWidth: "2" }), /* @__PURE__ */ react.createElement("path", { pathLength: 100, d: "M3 9h18M9 21V9", strokeOpacity: 0.5 }), /* @__PURE__ */ react.createElement("path", { d: "M15 15l2 2", strokeOpacity: 0.3 }));
    case "input":
      return /* @__PURE__ */ react.createElement("svg", { ...props }, /* @__PURE__ */ react.createElement("path", { pathLength: 100, d: "M12 3v12m0 0l-4-4m4 4l4-4M4 21h16" }));
    case "output":
      return /* @__PURE__ */ react.createElement("svg", { ...props }, /* @__PURE__ */ react.createElement("path", { pathLength: 100, d: "M12 3v14m-5-5l5 5 5-5M4 21h16", strokeWidth: "2" }), /* @__PURE__ */ react.createElement("path", { d: "M7 12h10", strokeOpacity: 0.3 }));
    default:
      return /* @__PURE__ */ react.createElement("svg", { ...props }, /* @__PURE__ */ react.createElement("circle", { cx: "12", cy: "12", r: "5", fill: active ? COLOR_TOKENS.primary : "#ccc" }));
  }
};
const getBezierPath = (x1, y1, x2, y2, isLoop = false) => {
  if (isLoop) {
...
const FlowAnimator = ({
  ...
  const frame = (0,cjs.useCurrentFrame)();
  const { width, height, fps } = (0,cjs.useVideoConfig)();
  const isActive = (phase) => activePhase === 0 || phase === activePhase;
  const cameraX = (0,cjs.interpolate)(frame, [0, 400], [0, -50]);
  ...
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { backgroundColor: "#f5f5f7", overflow: "hidden" } }, /* @__PURE__ */ react.createElement("div", { style: {
    position: "absolute",
    inset: 0,
    ...
    opacity: (0,cjs.interpolate)(frame, [0, 20], [0, 1])
  } }, /* @__PURE__ */ react.createElement(Typography, { text: title, fontSize: 48, color: "#111", fontWeight: 800, letterSpacing: 1 }), /* @__PURE__ */ react.createElement("div", { style: {
    width: 60,
    height: 4,
    background: COLOR_TOKENS.primary,
    margin: "15px auto",
    transform: `scaleX(${(0,cjs.interpolate)(frame, [10, 30], [0, 1], { extrapolateRight: "clamp" })})`
  } }))), /* @__PURE__ */ react.createElement("div", { style: {
    width: "100%",
    height: "100%",
    ...
    return /* @__PURE__ */ react.createElement("div", { key: group.id, style: {
      position: "absolute",
      left: group.x * 1,
      top: group.y * 0.8,
      width: group.w * 1,
      ...
      alignItems: "center",
      paddingTop: "20px"
    } }, /* @__PURE__ */ react.createElement("div", { style: { opacity: active ? 1 : 0.5 } }, /* @__PURE__ */ react.createElement(Typography, { text: group.label, fontSize: 16, color: active ? "#111" : "#999", fontWeight: 800 })), /* @__PURE__ */ react.createElement("div", { style: {
      position: "absolute",
      bottom: -50,
      left: "50%",
      transform: "translateX(-50%)",
      ...
      textAlign: "center",
      width: "100%"
    } }, /* @__PURE__ */ react.createElement(Typography, { text: group.logo, fontSize: 14, color: "#333", fontWeight: 900 }), /* @__PURE__ */ react.createElement("div", { style: { fontSize: 9, color: "#666", letterSpacing: 1, fontWeight: 700 } }, "PARTNER LOGO")));
  }), /* @__PURE__ */ react.createElement("svg", { width: width + 200, height, style: { position: "absolute" } }, /* @__PURE__ */ react.createElement("defs", null, /* @__PURE__ */ react.createElement("filter", { id: "glow-light", x: "-50%", y: "-50%", width: "200%", height: "200%" }, /* @__PURE__ */ react.createElement("feGaussianBlur", { stdDeviation: "4", result: "blur" }), /* @__PURE__ */ react.createElement("feMerge", null, /* @__PURE__ */ react.createElement("feMergeNode", { in: "blur" }), /* @__PURE__ */ react.createElement("feMergeNode", { in: "SourceGraphic" })))), edges.map((edge, i) => {
    ...
    return /* @__PURE__ */ react.createElement("g", { key: `edge-${i}`, opacity: active ? 1 : 0.1, style: { transition: "opacity 0.8s" } }, /* @__PURE__ */ react.createElement("path", { d: path, fill: "none", stroke: "rgba(0,0,0,0.08)", strokeWidth: "3", strokeLinecap: "round" }), /* @__PURE__ */ react.createElement(
      "path",
      {
        d: path,
        fill: "none",
    ...
    const delay = i * 2;
    const nodeSpring = (0,cjs.spring)({ frame: frame - delay, fps, config: { damping: 12, stiffness: 100 } });
    return /* @__PURE__ */ react.createElement(
      "div",
      {
        key: node.id,
      ...
      } }, /* @__PURE__ */ react.createElement(NodeIcon, { type: node.type, active, delay }), /* @__PURE__ */ react.createElement("div", { style: { marginTop: 12 } }, /* @__PURE__ */ react.createElement(Typography, { text: node.label, fontSize: 14, color: active ? "#111" : "#666", fontWeight: 700, textAlign: "center" }))),
      node.metadata && active && activePhase === node.phase && /* @__PURE__ */ react.createElement("div", { style: { position: "absolute", left: 160, top: 0 } }, /* @__PURE__ */ react.createElement(DataOverlay, { data: node.metadata, delay: delay + 20 }))
    );
  })));
};

;// CONCATENATED MODULE: ./src/components/showreel/FlowDefinitions.ts
const PLASTIC_FLOW_NODES = [
  ...
  {
    id: "recycler",
    label: "Plastic Recycler",
    x: 580,
    y: 400,
    type: "container",
    phase: 2,
    subNodes: ["sorting", "grinding", "pre_comp", "post_comp"],
...
const STEEL_FLOW_NODES = [
  ...
  {
    id: "recycler",
    label: "Steel Recycler",
    x: 580,
    y: 440,
    type: "container",
    phase: 2,
    subNodes: ["heat", "rolling", "bars"],
  ...
  {
    id: "supplier",
    label: "Tier 1/2/3 Supplier",
    x: 740,
    y: 440,
    type: "container",
    phase: 3,
    subNodes: ["forging", "machining", "assembly", "wheel_hub"],
...
;// CONCATENATED MODULE: ./src/Showreel.tsx
...
const Showreel = () => {
  return /* @__PURE__ */ React.createElement(TransitionSeries, null, /* @__PURE__ */ React.createElement(TransitionSeries.Sequence, { durationInFrames: 60 }, /* @__PURE__ */ React.createElement(Section1_Intro, null)), /* @__PURE__ */ React.createElement(
    TransitionSeries.Transition,
    {
      presentation: fade(),
      timing: linearTiming({ durationInFrames: 30 })
    }
  ), /* @__PURE__ */ React.createElement(TransitionSeries.Sequence, { durationInFrames: 180 }, /* @__PURE__ */ React.createElement(
    FlowAnimator,
    {
  ...
  ), /* @__PURE__ */ React.createElement(TransitionSeries.Sequence, { durationInFrames: 150 }, /* @__PURE__ */ React.createElement(
    FlowAnimator,
    {
      nodes: PLASTIC_FLOW_NODES,
      edges: PLASTIC_FLOW_EDGES,
  ...
  ), /* @__PURE__ */ React.createElement(TransitionSeries.Sequence, { durationInFrames: 60 }, /* @__PURE__ */ React.createElement(Outro, null)));
};

;// CONCATENATED MODULE: ./src/SteelFlow.tsx
...
const SteelFlow = () => {
  return /* @__PURE__ */ react.createElement(TransitionSeries, null, /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: 180 }, /* @__PURE__ */ react.createElement(
    FlowAnimator,
    {
      nodes: STEEL_FLOW_NODES,
      edges: STEEL_FLOW_EDGES,
  ...
  )), /* @__PURE__ */ react.createElement(TransitionSeries.Transition, { presentation: fade(), timing: linearTiming({ durationInFrames: 30 }) }));
};

;// CONCATENATED MODULE: ./node_modules/lucide-react/dist/esm/icons/factory.js
/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
;// CONCATENATED MODULE: ./node_modules/lucide-react/dist/esm/icons/flame.js
/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
;// CONCATENATED MODULE: ./node_modules/lucide-react/dist/esm/icons/hammer.js
/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
;// CONCATENATED MODULE: ./node_modules/lucide-react/dist/esm/icons/car.js
/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
;// CONCATENATED MODULE: ./src/components/showreel/MojoComponents.tsx


const StageNode = ({ Icon, label, delay, x, y }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const { fps } = (0,cjs.useVideoConfig)();
  const entry = (0,cjs.spring)({
    frame: frame - delay,
    fps,
  ...
  return /* @__PURE__ */ react.createElement(
    "div",
    {
      ...
      style: {
        ...
        opacity: (0,cjs.interpolate)(frame, [delay, delay + 10], [0, 1])
      }
    },
    /* @__PURE__ */ react.createElement(Icon, { size: 48, className: "text-[#4CAF50]" }),
    /* @__PURE__ */ react.createElement("span", { className: "text-sm font-black text-[#1A1A1A] tracking-tighter uppercase" }, label)
  );
};
const DataCounter = ({ value, label, delay, x, y }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const { fps } = (0,cjs.useVideoConfig)();
  const count = Math.floor((0,cjs.interpolate)(frame, [delay, delay + 60], [0, value], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.bezier(0.33, 1, 0.68, 1)
  }));
  return /* @__PURE__ */ react.createElement(
    "div",
    {
      className: "absolute flex flex-col items-start",
      style: { left: x, top: y, opacity: (0,cjs.interpolate)(frame, [delay, delay + 10], [0, 1]) }
    },
    /* @__PURE__ */ react.createElement("span", { className: "text-6xl font-black text-[#1A1A1A] tabular-nums italic" }, count.toLocaleString()),
    /* @__PURE__ */ react.createElement("span", { className: "text-xs font-bold text-[#4CAF50] ml-1 tracking-[0.2em]" }, label)
  );
};
const Highlighter = ({ text, delay, className }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const progress = (0,cjs.interpolate)(frame, [delay, delay + 25], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.bezier(0.33, 1, 0.68, 1)
  });
  return /* @__PURE__ */ react.createElement("span", { className: `relative inline-block ${className || ""}` }, /* @__PURE__ */ react.createElement(
    "span",
    {
...
const CO2Tag = ({ val, delay, x, y }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement("span", { className: "text-[10px] font-black tracking-widest leading-none" }, "\u25B2 ", val)
  );
};

;// CONCATENATED MODULE: ./src/scenes/SteelMojoScene.tsx




const SteelMojoScene = () => {
  const frame = (0,cjs.useCurrentFrame)();
  const { width, height } = (0,cjs.useVideoConfig)();
  const STAGES = {
  ...
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { className: "bg-[#F9F9F9] overflow-hidden" }, /* @__PURE__ */ react.createElement(
    "div",
    {
  ...
  ), /* @__PURE__ */ react.createElement("svg", { className: "absolute w-full h-full pointer-events-none" }, /* @__PURE__ */ react.createElement(
    "path",
    {
      d: pathD,
      fill: "none",
  ...
  )), /* @__PURE__ */ react.createElement(StageNode, { Icon: Truck, label: "Recovery", delay: 0, x: STAGES.RECOVERY.x, y: STAGES.RECOVERY.y }), /* @__PURE__ */ react.createElement(StageNode, { Icon: Factory, label: "Scrapping", delay: 150, x: STAGES.SCRAPPING.x, y: STAGES.SCRAPPING.y }), /* @__PURE__ */ react.createElement(StageNode, { Icon: Flame, label: "Steel Recycler", delay: 300, x: STAGES.SMELTING.x, y: STAGES.SMELTING.y }), /* @__PURE__ */ react.createElement(StageNode, { Icon: Hammer, label: "Tier Supplier", delay: 450, x: STAGES.FORGING.x, y: STAGES.FORGING.y }), /* @__PURE__ */ react.createElement(StageNode, { Icon: Car, label: "Vehicle Production", delay: 600, x: STAGES.PRODUCTION.x, y: STAGES.PRODUCTION.y }), /* @__PURE__ */ react.createElement(DataCounter, { value: 6607, label: "ELVs RECOVERED", delay: 80, x: STAGES.RECOVERY.x - 50, y: STAGES.RECOVERY.y + 100 }), /* @__PURE__ */ react.createElement(DataCounter, { value: 1100, label: "HEAT JOBS", delay: 380, x: STAGES.SMELTING.x - 50, y: STAGES.SMELTING.y + 100 }), /* @__PURE__ */ react.createElement("div", { className: "absolute left-[54%] top-[30%]" }, /* @__PURE__ */ react.createElement(Highlighter, { text: "Vardhm\u0101n", delay: 350, className: "text-3xl font-black italic tracking-tighter" })), /* @__PURE__ */ react.createElement("div", { className: "absolute left-[74%] top-[68%]" }, /* @__PURE__ */ react.createElement(Highlighter, { text: "Satelite Forging", delay: 500, className: "text-xl font-bold tracking-tight" })), /* @__PURE__ */ react.createElement("div", { className: "absolute left-[88%] top-[25%] text-right" }, /* @__PURE__ */ react.createElement(Highlighter, { text: "Maruti Suzuki", delay: 650, className: "text-2xl font-black tracking-tighter" })), /* @__PURE__ */ react.createElement(CO2Tag, { val: "0.42 tCO2e", delay: 180, x: STAGES.SCRAPPING.x + 80, y: STAGES.SCRAPPING.y - 40 }), /* @__PURE__ */ react.createElement(CO2Tag, { val: "0.22 tCO2e", delay: 480, x: STAGES.FORGING.x - 80, y: STAGES.FORGING.y - 40 }), /* @__PURE__ */ react.createElement("div", { className: "absolute top-16 left-16" }, /* @__PURE__ */ react.createElement("div", { className: "flex items-center gap-4" }, /* @__PURE__ */ react.createElement("div", { className: "w-4 h-4 rounded-full bg-[#4CAF50] animate-pulse" }), /* @__PURE__ */ react.createElement("span", { className: "text-xs font-black tracking-[0.5em] text-[#4CAF50] uppercase" }, "Live Supply Chain Sync")), /* @__PURE__ */ react.createElement("h1", { className: "text-7xl font-black text-[#1A1A1A] tracking-tighter mt-4 leading-[0.8]" }, "STEEL OVERALL FLOW")));
};

;// CONCATENATED MODULE: ./src/SteelMojo.tsx
...
/* harmony import */ var remotion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3626);
...
/* harmony import */ var remotion_no_react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2453);
